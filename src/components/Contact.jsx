...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(
        "https://getform.io/f/8c8e9f40-5ea5-4c1e-8179-be3d5f25e527",
        userData
      )
      .then((response) => {
      ...
      <div className="flex flex-col lg:flex-row md:flex-row gap-10">
        <div className="basis-2/6">
          ...
          <p className="mt-4 md:mt-8 lg:mt-8">
            ...
            okoropreciousejiro19@gmail.com
          </p>
          <p>
          ...
          <div className="mt-8 mb-12">
            <a
              href="https://www.linkedin.com/in/precious-okoro19/"
              target="_blank"
            >
              <i className="fa-brands fa-linkedin  text-3xl text-[#ababab] mr-6 transform duration-[0.5s] hover:text-[#ff004f] translate-y-[-5]"></i>
            </a>
            <a href="https://github.com/OkoroPrecious" target="_blank">
              <i className="fa-brands fa-github text-3xl text-[#ababab] mr-6 transform duration-[0.5s] hover:text-[#ff004f] translate-y-[-5]"></i>
            </a>
            <a
              href="https://www.instagram.com/preciouslilyofficial/"
              target="_blank"
            >
              <i className="fa-brands fa-square-instagram text-3xl text-[#ababab] mr-6 transform duration-[0.5s] hover:text-[#ff004f] translate-y-[-5]"></i>
            </a>
          </div>
          <a
            href="images/precious_cv.pdf"
            download
